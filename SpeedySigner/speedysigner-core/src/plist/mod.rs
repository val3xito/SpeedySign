...
impl PlistEditor {
    ...
    pub fn set_bundle_id(&mut self, bundle_id: &str) {
        self.dict.insert("CFBundleIdentifier".to_string(), Value::String(bundle_id.to_string()));
    }

    /// Cambia el nombre de visualización (Display Name)
    pub fn set_display_name(&mut self, display_name: &str) {
        self.dict.insert("CFBundleDisplayName".to_string(), Value::String(display_name.to_string()));
        self.dict.insert("CFBundleName".to_string(), Value::String(display_name.to_string()));
    }

    /// Cambia las versiones
    pub fn set_version(&mut self, version: &str) {
        self.dict.insert("CFBundleShortVersionString".to_string(), Value::String(version.to_string()));
        self.dict.insert("CFBundleVersion".to_string(), Value::String(version.to_string()));
    }

    /// Habilita compartir archivos de la app en la app Archivos de iOS
    pub fn enable_file_sharing(&mut self) {
        self.dict.insert("UIFileSharingEnabled".to_string(), Value::Boolean(true));
        self.dict.insert("LSSupportsOpeningDocumentsInPlace".to_string(), Value::Boolean(true));
    }
